...
class ColetaDadosEstatisticosCountAll {
    constructor() {
        this.start()
    }
    ...
    async start() {
      try {
        ...
        const rsltLogsRegister = await fnGerarLogs({
          ...
          nome_arquivo: null,
          error: false,
          entidade: "DADOS_ESTATISTICOS_COUNTALL",
          quantidade: JSON.stringify(arraySqls),
          categoria: "DADOS_ESTATISTICOS_COUNTALL",
        ...
        const rsltLogsRegister = await fnGerarLogs({
          ...
          entidade: "DADOS_ESTATISTICOS_COUNTALL",
          quantidade: null,
          categoria: "DADOS_ESTATISTICOS_COUNTALL_ERRO",
...
module.exports = ColetaDadosEstatisticosCountAll;